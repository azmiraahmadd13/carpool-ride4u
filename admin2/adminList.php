                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Username</th>
                                                <th>Password</th>
												<th style="center" colspan=2>Action</th>
					...
					?>
                                        ...
                                        <tbody>
                                           <tr>
                                                ...
                                                <th> <a href="deleteAdmin.php?Id=<?php echo $row['Id']; ?>" onClick="return confirm('Are You Sure?')">Delete</a> </th>
												<th > <a href="updateAdmin.php?Id=<?php echo $row['Id']; ?>" onClick="return confirm('Are You Sure?')">Update</a> </th>
                                            </tr>
                                           <?php 
							}
						} else {
