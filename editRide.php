        ...
        <div class="row align-items-center mb-5">
          <div class="col-md-5 pr-md-5 mb-5">
			...
			<?php 
				...
				<form action="updateRide1.php?rideId=<?php echo $row['rideId']; ?>"  method="post">
				
				
					<tr> 
						<td align="center" width="30%">Location: </td>
						<tr><input class="Minput" type="text" name="location" value="<?php echo $row['location']; ?> " autofocus ></tr>
					</tr>					
					<tr> 
						<td align="center" width="30%">Destination: </td>
						<td><input class="Minput" type="text" name="destination" value="<?php echo $row['destination']; ?> "  ></td>
					</tr>
					<tr> 
						<td align="center" width="30%">Date: </td>
						<td><input class="Minput" type="text" name="date" value="<?php echo $row['date']; ?> " ></td>
					</tr>
					<tr> 
						<td align="center" width="30%">Time: </td>
						<td><input class="Minput" type="text" name="time" value="<?php echo $row['time']; ?> "  ></td>
					</tr>
					...
					<tr> 
						<td> </td>
						<td><input type="submit" name="submit" value="Save" onclick=""  /></td>
					</tr>
