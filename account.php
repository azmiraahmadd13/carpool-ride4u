	  ...
	  <div class="contact-form">
        <div class="row align-items-center mb-5">
          <div class="col-md-5 pr-md-5 mb-5">
            ...
            <input type="submit" value="Profile" onclick="window.location.href='profile.php'" />
			<input type="submit" value="Carpool" onclick="window.location.href='history11.php'" />
			<input type="submit" value="My Ride " onclick="window.location.href='myride22.php'" />
